...
const JuegoEscudoRespeto = () => {
  ...
  const avatarString =
    typeof avatarData === "string"
      ? avatarData.toLowerCase()
      : JSON.stringify(avatarData).toLowerCase();
  const avatarUsuario =
    Object.keys(avataresEs).find((animal) => avatarString.includes(animal)) ||
    "dragon";
  ...
  const generateScenario = async () => {
    ...
    const personajes = [
      "alguien que dice tener tu edad",
      'un "amigo" de internet',
      "alguien popular de tu escuela",
      "una persona que dice ser moderador",
      "alguien que dice ser YouTuber famoso",
      "un compañero de clase",
      "alguien que conociste jugando",
      "una cuenta verificada falsa",
    ];

    const temaRandom = temas[Math.floor(Math.random() * temas.length)];
    const plataformaRandom =
      plataformas[Math.floor(Math.random() * plataformas.length)];
    const contextoRandom =
...
Responde SOLO con este JSON (sin markdown):
{
  ...
  "opciones": [
    ...
    try {
      ...
      const fallbackScenarios = [
        {
          situacion:
            "Estás en un servidor de Discord de tu juego favorito. Alguien que dice tener 12 años te manda mensaje privado diciendo que puede darte skins gratis de Fortnite. Solo necesita que le pases tu usuario y contraseña de Epic Games, y que no le cuentes a nadie porque es un 'truco secreto'.",
          tema: "grooming_regalos",
          plataforma: "Discord",
          opciones: [
            {
              texto: "Le doy mis datos porque quiero las skins gratis",
              correcta: false,
              feedback:
                "¡Nunca compartas tu contraseña! Las skins gratis no existen así. Esta persona probablemente es un adulto que quiere robarte la cuenta o hacerte daño. Perderías todo tu progreso y dinero invertido.",
            },
            {
              texto: "No le doy nada, lo bloqueo y le cuento a mis papás",
              correcta: true,
              feedback:
                "¡Excelente decisión! Reconociste las señales de peligro: regalos gratis + pide contraseña + quiere secretos = PELIGRO. Bloquear y contarle a un adulto es siempre lo correcto.",
            },
            {
              texto:
                "Le digo que no pero sigo hablando con él porque es amable",
              correcta: false,
              feedback:
                "Aunque no le diste tus datos, mantener contacto con alguien que intentó engañarte es peligroso. Los groomers son pacientes y seguirán intentando. Lo mejor es cortar todo contacto.",
            },
          ],
          generadoPorIA: false,
        },
        {
          situacion:
            "En el grupo de WhatsApp de tu salón, empezaron a circular capturas de pantalla de una conversación privada de tu compañera María donde hablaba de un chico que le gusta. Todos se están riendo y haciendo memes. Te etiquetan para que opines.",
          tema: "ciberacoso_grupal",
          plataforma: "WhatsApp",
          opciones: [
            {
              texto: "Me río y comparto los memes porque todos lo hacen",
              correcta: false,
              feedback:
                "Participar en las burlas te convierte en parte del problema. María está siendo humillada y esto puede afectarla mucho. Imagina cómo te sentirías tú si compartieran tus conversaciones privadas.",
            },
            {
              texto: "No participo, salgo del grupo y le cuento a un adulto",
              correcta: true,
              feedback:
                "¡Muy bien! No participar es importante, pero reportarlo es aún mejor. María necesita ayuda y un adulto puede detener esto antes de que empeore. Ser valiente es hacer lo correcto aunque sea difícil.",
            },
            {
              texto: "No digo nada y solo ignoro los mensajes",
              correcta: false,
              feedback:
                "Ignorar no detiene el acoso. María sigue siendo lastimada mientras tú miras. El silencio de los testigos permite que el bullying continúe. Necesitas actuar para ayudarla.",
            },
          ],
          generadoPorIA: false,
        },
        {
          situacion:
            "Tu crush te manda un TikTok privado y te dice que le gustas mucho. Luego te pide que le mandes una foto tuya en ropa interior. Dice que él/ella ya te mandó una (aunque tú no la pediste) y que si no lo haces es porque no confías en él/ella.",
          tema: "sexting_presion",
          plataforma: "TikTok",
          opciones: [
            {
              texto:
                "Le mando la foto porque no quiero que piense que no confío",
              correcta: false,
              feedback:
                "Esto es chantaje emocional. Alguien que te quiere de verdad NUNCA te presionaría así. Esa foto puede terminar en internet para siempre, ser compartida con toda la escuela, o usada para chantajearte después.",
            },
            {
              texto:
                "Le digo que no, lo bloqueo y le cuento a un adulto de confianza",
              correcta: true,
              feedback:
                "¡Perfecto! Decir NO es tu derecho y no tienes que dar explicaciones. Esta persona no te respeta. Bloquearla y contarle a un adulto te protege de más presión y chantaje.",
            },
            {
              texto: "Le digo que no pero no lo bloqueo porque me gusta",
              correcta: false,
              feedback:
                "Alguien que te presiona para mandarte fotos íntimas no te quiere bien, te está manipulando. Si sigues en contacto, seguirá intentándolo. Mereces a alguien que te respete de verdad.",
            },
          ],
          generadoPorIA: false,
        },
        {
          situacion:
            "Recibes un mensaje directo en Instagram de una cuenta verificada que dice ser de MrBeast. Te dice que ganaste un iPhone pero necesitas darle tu contraseña de Instagram para 'verificar que eres real' y recibir el premio.",
          tema: "phishing_premio",
          plataforma: "Instagram",
          opciones: [
            {
              texto: "Le doy mi contraseña porque está verificado y es MrBeast",
              correcta: false,
              feedback:
                "¡Es una estafa! Los verificados falsos existen y los famosos NUNCA piden contraseñas. Si das tu contraseña, perderás tu cuenta, y podrían usarla para estafar a tus amigos haciéndose pasar por ti.",
            },
            {
              texto:
                "Ignoro el mensaje, lo reporto como spam y no doy ningún dato",
              correcta: true,
              feedback:
                "¡Excelente! Reconociste una estafa clásica. Ningún sorteo real pide contraseñas. Reportar ayuda a que Instagram cierre esas cuentas falsas y proteja a otros.",
            },
            {
              texto:
                "Le pido más pruebas de que es real antes de darle mis datos",
              correcta: false,
              feedback:
                "Los estafadores son expertos en dar 'pruebas' falsas. No importa qué tan convincentes parezcan, NUNCA debes dar tu contraseña a nadie. La única respuesta segura es ignorar y reportar.",
            },
          ],
          generadoPorIA: false,
        },
        {
          situacion:
            "En Roblox conociste a alguien que dice tener tu edad y se ha vuelto tu 'mejor amigo'. Llevan semanas hablando todos los días. Ahora te dice que quiere conocerte en persona y te pide que no le cuentes a tus papás porque 'no van a entender su amistad'.",
          tema: "grooming_secretos",
          plataforma: "Roblox",
          opciones: [
            {
              texto: "Acepto verlo porque ya lo conozco bien y es mi amigo",
              correcta: false,
              feedback:
                "¡Peligro! No importa cuánto hayas hablado, NO conoces a esta persona en realidad. Puede ser un adulto mintiendo sobre su edad. Pedir secretos y encuentros es una señal grave de grooming.",
            },
            {
              texto: "Le digo que no puedo verlo y le cuento todo a mis papás",
              correcta: true,
              feedback:
                "¡Muy bien! Reconociste las señales de peligro. Alguien que te pide secretos y quiere verte a escondidas tiene malas intenciones. Tus papás pueden ayudarte a mantenerte seguro.",
            },
            {
              texto:
                "Le digo que no a la reunión pero sigo siendo su amigo en el juego",
              correcta: false,
              feedback:
                "Esta persona ya mostró intenciones peligrosas. Aunque no lo veas en persona, seguir hablando le permite seguir manipulándote. Necesitas cortar contacto y contarle a un adulto todo lo que pasó.",
            },
          ],
          generadoPorIA: false,
        },
        {
          situacion:
            "En el grupo de tu equipo de fútbol en WhatsApp, empezaron a burlarse de Carlos porque falló un penal. Le pusieron un apodo cruel y están haciendo stickers con su cara. Tú también estás en el grupo.",
          tema: "bullying_burlas",
          plataforma: "WhatsApp",
          opciones: [
            {
              texto: "Me río y uso los stickers porque es solo una broma",
              correcta: false,
              feedback:
                "Para ti es 'broma' pero para Carlos es humillación. Los apodos crueles y burlas constantes son bullying y pueden causarle mucho daño emocional. Participar te hace parte del problema.",
            },
            {
              texto: "Defiendo a Carlos en el grupo y le aviso al entrenador",
              correcta: true,
              feedback:
                "¡Excelente! Se necesita valor para defender a alguien. Avisarle al entrenador ayuda a que esto pare. Los verdaderos equipos se apoyan, no se burlan de los errores.",
            },
            {
              texto: "No participo pero tampoco digo nada",
              correcta: false,
              feedback:
                "Tu silencio permite que el acoso continúe. Carlos necesita que alguien lo defienda. Cuando nadie dice nada, los acosadores sienten que está bien lo que hacen.",
            },
          ],
          generadoPorIA: false,
        },
  ...
  const handleChoice = (option) => {
    ...
    if (option.correcta) {
      ...
      const reporteError = `Tema: ${currentScenario.tema}. Falló al elegir: "${option.texto}". Razón: ${option.feedback}`;
      setErroresPartida((prev) => [...prev, reporteError]);
    }
  };
    ...
    if (lives <= 0 || scenarioCount >= GAME_CONSTANTS.MAX_SCENARIOS) {
      if (!puntosGuardados) {
        setPerfilActivo((prev) => ({
          ...prev,
          puntosExperiencia: (prev?.puntosExperiencia || 0) + score,
        }));
        ...
        if (perfilActivo?.id) {
          ...
          console.warn(
            "No se encontró el ID del perfil. No se guardará en Firestore.",
          );
        }
        ...
        <div style={styles.card}>
          <div style={styles.centerContent}>
            ...
            <p style={styles.subtitle}>
              Aprende a protegerte en internet. Enfrentarás situaciones reales y
              deberás tomar la mejor decisión.
            </p>
            ...
            <div style={styles.rulesBox}>
              ...
              <div style={styles.ruleItem}>
                ...
                <span>
                  Tienes <strong>3 vidas</strong> - cada error resta una
                </span>
              </div>
              <div style={styles.ruleItem}>
                <div style={styles.ruleIcon}>
                ...
                <span>
                  Ganas <strong>100 puntos</strong> por respuesta correcta
                </span>
              </div>
              <div style={styles.ruleItem}>
                <div style={styles.ruleIcon}>
                ...
                <span>
                  Completa <strong>5 escenarios</strong> para ganar
                </span>
              </div>
            </div>
  ...
  return (
    <div style={{ ...styles.container, position: "relative" }}>
      {" "}
      {/* ---> NUEVO: Añadido position: relative al contenedor principal para que el absolute del personaje funcione */}
      ...
      {/* Header con stats */}
      <div style={{ ...styles.header, zIndex: 10 }}>
        {" "}
        {/* ---> NUEVO: zIndex 10 para asegurar que la UI quede sobre el personaje */}
        ...
        <div style={styles.progressContainer}>
          <span style={styles.progressText}>
            {scenarioCount}/{GAME_CONSTANTS.MAX_SCENARIOS}
          </span>
        ...
        {!showFeedback ? (
          ...
          <div style={styles.centerContent}>
            ...
            <button onClick={nextScenario} style={styles.continueButton}>
              {scenarioCount >= GAME_CONSTANTS.MAX_SCENARIOS ||
              lives <= (feedbackData.correcta ? 0 : 1)
                ? "Ver resultados"
                : "Siguiente escenario"}{" "}
              ➡️
            </button>
